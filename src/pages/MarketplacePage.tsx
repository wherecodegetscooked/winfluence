        ...
        {isLoading ? (
          ...
          <>
            <div className="mt-20 hidden xl:mt-24 xl:block">
              <div className="grid grid-cols-[1.05fr_1.8fr_1.05fr_.8fr_.65fr_1.15fr_1fr_160px] gap-x-6 border-b border-zinc-200 pb-4 text-[17px] font-medium text-zinc-500">
...
const CampaignRow: React.FC<{ campaign: Campaign; language: Language; now: number }> = ({ campaign, language, now }) => {
  ...
  return (
    <article className="grid min-h-[138px] grid-cols-[1.05fr_1.8fr_1.05fr_.8fr_.65fr_1.15fr_1fr_160px] items-center gap-x-6 border-b border-zinc-200 py-7 text-[18px]">
      <div className="flex min-w-0 items-center gap-5">
        <img src={campaign.campaignVisualUrl} alt="" className="h-14 w-14 shrink-0 rounded-full object-cover" />
        <span className="truncate font-normal">{campaign.brandName}</span>
      </div>
    ...
    <article className="py-8">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <p className="truncate text-lg font-normal">{campaign.brandName}</p>
        </div>
      </div>
